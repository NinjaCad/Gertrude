...
def test_PWC():
    ...
    player_number, player_dict = game.playersWithCards(players, Marlin)
...
def test_PWC_TwoPlayer():
    ...
    players = [Marlin, Dory]
    Dory.setHand([cards[0], cards[1], cards[2], cards[3], cards[4]], isKnown=True)
    Marlin.setHand([cards[0], cards[1], cards[2], cards[3], cards[0]], isKnown=True)
    #Don't neet to set Dory and Marlins cards as they will start with 0.
